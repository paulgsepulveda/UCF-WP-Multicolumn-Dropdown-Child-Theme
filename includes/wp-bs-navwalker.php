...
if ( !class_exists( 'bs4Navwalker_com' ) ) {
	...
	class bs4Navwalker_com extends Walker_Nav_Menu
	{
		/**
		...
		*/
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			// Hacky solution - WordPress is incorrectly applying the current-menu-item class on the front page
			if (is_front_page()) {
